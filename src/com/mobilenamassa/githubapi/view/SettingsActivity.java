...
public class SettingsActivity extends Activity {
	...
	public void save(View view) {
		if (TextUtils.isEmpty(this.username.getText()) || TextUtils.isEmpty(this.password.getText()) || TextUtils.isEmpty(this.repository.getText()) || TextUtils.isEmpty(this.frequency.getText())) {
